...
const MenuItem = (props) => {
  const {id, imgUrl ,name ,emoji , ingredients, directions, instructions, small, medium, large} = props
  const [openModal, setOpenModal] = useState(false)
  return (

    // creating a template component for an item in the data.json 
    <div id={props.id} className='relative max-w-[450px] h-[450px] w-full mx-auto my-3 py-16 px-4' >
        <img className='object-cover w-full h-full rounded-2xl bg-center bg-cover duration-500 ' src={props.imgUrl} alt="" />
