...
const MenuItem = ({id, imgUrl ,name ,emoji , ingredients, directions, instructions}) => {
  ...
  return (
    ...
    <div id={id} className='relative max-w-[450px] h-[450px] w-full mx-auto my-3 py-16 px-4' >
        ...
        <Modal open={openModal} name={name} imgUrl={imgUrl} emoji={emoji} ingredients={ingredients} directions={directions} instructions={instructions} id={id} onClose={() => setOpenModal(false)}/>
        <div className='' >
