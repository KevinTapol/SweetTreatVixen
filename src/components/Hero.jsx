...
const Hero = () => {
  ...
  return (
    <div id='main' className='md:mb-1 mb-0 relative' >
        <img className='w-full h-full relative object-cover object-left' src={pizza} alt="" />
        <div className='w-full h-full absolute top-0 left-0 bg-white/40 flex justify-center items-center' >
          <div ref={myRef} className={`${myElementIsVisible ? 'absolute main_text flex flex-col' : 'absolute  opacity-0' }`} >
            <h1 className='md:text-4xl text-xl font-bold text-gray-800' >Sweet Treat Vixen</h1>
